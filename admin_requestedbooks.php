...
?>
    ...
    <head>
        ...
        <title>admin_requestedbooks</title>
        <style>
            body{
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <div class="s-content">
            <ul>
                ...
                <li><a style="color:rgb(41, 2, 73); background-color: rgb(231, 180, 13);" href="#">Requsted Books</a></li>
                <li><a href="admin_deletedbooks.php">Deleted Books</a></li>
            </ul>
        </div>
        <?php 
            $query = "SELECT * FROM addbook WHERE BuyStatus= 'REQ'";
